...
INSERT INTO `supplyorder`(date_submitted, supplyID, quantity, item_price, expected_delivery, issueID, actual_delivery)
	VALUES('2023-05-01', (SELECT supplyID FROM supplies WHERE supplyName = 'tubing'), '75', '15.99', '2023-05-07', (SELECT issueID FROM supplierissues WHERE issueDescription = 'Everything looks good!'),'2023-05-07');
